...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        VM = ViewModelProvider(this, SongViewModelFactory(application)).get(songVM::class.java)
...
//                            }
    ...
    override fun onStop() {
        super.onStop()
        SpotifyAppRemote.disconnect(spotifyAppRemote) // Disconnect to prevent leaks
    }
